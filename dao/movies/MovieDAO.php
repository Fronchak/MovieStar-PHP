...
require_once('dao/movies/MovieDAOInterface.php');
...
class MovieDAO implements MovieDAOInterface {
  ...
  public function create(Movie $movie) {
    ...
    $stmt->bindParam(':user_id', $movie->userId);

    $stmt->execute();

    $this->message->setMessage('Filme adicionado com sucesso', 'alert-success');
  }
